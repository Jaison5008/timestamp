...
router.get("/", function (request, response) {
  response.send("Node server timestamp");
});
...
// adding new text file to a folder with content current timestamp; http://localhost:3000/file
...
// retrieving the added text files list from folder   http://localhost:3000/file
